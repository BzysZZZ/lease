...
import com.pzj.lease.common.constant.RedisConstant;
...
import com.pzj.lease.web.admin.service.LoginService;
...
public class LoginServiceImpl implements LoginService {
    ...
    public CaptchaVo getCaptcha(){
        SpecCaptcha specCaptcha = new SpecCaptcha(130, 48, 4);  //验证码长度
    ...
    public String login(LoginVo loginVo){
        ...
        //2.校验验证码
        String code = stringRedisTemplate.opsForValue().get(loginVo.getCaptchaKey());   //真实验证码值
        if(code==null){
