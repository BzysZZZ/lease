...
import com.pzj.lease.web.admin.service.ApartmentInfoService;
...
public class ApartmentController {
    ...
    @GetMapping("pageItem")
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current, @RequestParam long size, ApartmentQueryVo queryVo, ServletRequest servletRequest) {
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) {
        ApartmentDetailVo  apartmentDetailVo = apartmentInfoService.detail(id);
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(@RequestParam Long id) {
        List<ApartmentInfo> apartmentInfoList=apartmentInfoService.listInfoByDistrict(id);
        return Result.ok();
    }
}
